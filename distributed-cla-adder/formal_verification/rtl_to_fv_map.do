...
# Generated on: Thu May 14 06:51:06 IST 2026 (Thu May 14 01:21:06 UTC 2026)
...
set logfile fv/distributed_cla_adder/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/distributed_cla_adder -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  cla.v
elaborate_design -golden -root {distributed_cla_adder} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/distributed_cla_adder/fv_map.v.gz
elaborate_design -revised -root {distributed_cla_adder}
...
write_compared_points noneq.compared_points.distributed_cla_adder.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.distributed_cla_adder.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.distributed_cla_adder.rtl.fv_map.rpt
